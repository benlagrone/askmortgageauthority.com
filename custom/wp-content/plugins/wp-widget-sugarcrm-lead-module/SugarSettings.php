...
$htaccess_protected = get_option( 'OEPL_is_SugarCRM_htaccess_Protected' );
$htaccess_username  = get_option( 'OEPL_SugarCRM_htaccess_Username' );
$htaccess_password  = get_option( 'OEPL_SugarCRM_htaccess_Password' );

$success_msg             = get_option( 'OEPL_SugarCRMSuccessMessage' );
$failure_msg             = get_option( 'OEPL_SugarCRMFailureMessage' );
$req_fields_message      = get_option( 'OEPL_SugarCRMReqFieldsMessage' );
$invalid_captcha_message = get_option( 'OEPL_SugarCRMInvalidCaptchaMessage' );

$ip_address_status           = get_option( 'OEPL_auto_IP_addr_status' );
$email_notification          = get_option( 'OEPL_Email_Notification' );
$email_notification_reveiver = get_option( 'OEPL_Email_Notification_Receiver' );
...
$email_checked = ( $email_notification === 'Y' ) ? 'checked="checked"' : '';
$ip_checked    = ( $ip_address_status === 'Y' ) ? 'checked="checked"' : '';
$redirect_cbx  = ( $redirect_status === 'Y' ) ? 'checked="checked"' : '';
$htacess_cbx   = ( $htaccess_protected === 'Y' ) ? 'checked="checked"' : '';

wp_unslash( $_GET );
if ( ( isset( $_GET['view'] ) && ! $_GET['view'] ) || ! isset( $_GET['view'] ) || empty( $_GET['view'] ) ) {
					...
					<tr height="30">
						<td>
							<div class="wp2sl_h2_div">
								<h2><?php esc_html_e( 'WP to CRM Sync', 'WP2SL' ); ?></h2>
							</div>
							...
							<div class="OEPL_tab_settings">
								...
								<div class="content">
									<form name="OEPl_sugarSettings" id="OEPl_sugarSettings" method="post">
										<input type="hidden" id="oepl_nonce" value="<?php echo esc_attr( wp_create_nonce( 'upload_thumb' ) ); ?>" name="oepl_nonce" />
										...
										<table class="form-table wp2sl_form_tabl">
											<?php
											if ( isset( $_GET['view'] ) && $_GET['view'] === 'sugarSettings' ) {
												/**************************************
												...
												<tr>
													<td><strong><?php esc_html_e( 'Sugar / SuiteCRM URL ', 'WP2SL' ); ?>:</strong><br />
														<input name="OEPL_SUGARCRM_URL" type="text" id="OEPL_SUGARCRM_URL" value="<?php echo esc_attr( get_option( 'OEPL_SUGARCRM_URL' ) ); ?>" size="53" required />
												...
												<tr>
													<td><strong><?php esc_html_e( 'SugarCRM Admin User', 'WP2SL' ); ?> :</strong><br />
														<input name="OEPL_SUGARCRM_ADMIN_USER" autocomplete="off" type="text" id="OEPL_SUGARCRM_ADMIN_USER" value="<?php echo esc_attr( get_option( 'OEPL_SUGARCRM_ADMIN_USER' ) ); ?>" size="25" required />
													</td>
												</tr>
												<tr>
												...
												<tr>
													<td colspan="2"><strong><?php esc_html_e( 'Is your SugarCRM .htaccess protected ?', 'WP2SL' ); ?></strong>&nbsp;&nbsp;
														<input type="checkbox" name="OEPL_is_htacess_protected" id="OEPL_is_htacess_protected" <?php echo $htacess_cbx; ?> />
													</td>
												</tr>
												<tr class="OEPL_htaccess_tr">
													<td><strong><?php esc_html_e( '.htaccess UserName', 'WP2SL' ); ?> : </strong><br />
														<input type="text" name="Oepl_Htaccess_Admin_User" id="Oepl_Htaccess_Admin_User" value="<?php echo $htaccess_username; ?>" />
													</td>
												</tr>
												<tr class="OEPL_htaccess_tr">
												...
												<tr>
													<td class="OEPL_reload_this"><input type="button" name="testConn" id="testConn" value="Test Connection" class="button button-large" />
														&nbsp;&nbsp;
														<input type="submit" value="<?php _e( 'Save Changes', 'WP2SL' ); ?>" class="button button-primary button-large OEPLsaveConfig" />
														&nbsp;&nbsp;
														<?php
														if ( get_option( 'OEPL_SUGARCRM_ADMIN_PASS' ) && get_option( 'OEPL_SUGARCRM_ADMIN_PASS' ) !== '' ) {
															?>
															<input type="button" value="<?php _e( 'Synchronize Lead Fields', 'WP2SL' ); ?>" id="LeadFldSync" class="button button-primary button-large" />
														<?php } ?>
													</td>
												</tr>
											<?php } ?>
											<?php
											if ( $_GET['view'] === 'generalSettings' ) {
												/**************************************
												...
												<tr>
													...
													<td>
														<select class="captchaSettings" name="captchaSettings">
															<option <?php echo ( $captcha_settings === 'Y' ? 'selected="selected"' : '' ); ?> value="Y"><?php esc_html_e( 'Active', 'WP2SL' ); ?></option>
															<option <?php echo ( $captcha_settings === 'N' || $captcha_settings === false ? 'selected="selected"' : '' ); ?> value="N"><?php esc_html_e( 'Inactive', 'WP2SL' ); ?></option>
														</select>
														<p class="description">
												...
												<tr class="reCAPTCHA_tr">
													...
													<td>
														<input type="text" class="oepl_recaptcha_site_key" value="<?php echo esc_attr( $oepl_recaptcha_site_key ); ?>" name="oepl_recaptcha_site_key" id="oepl_recaptcha_site_key" />
													</td>
												</tr>
												<tr class="reCAPTCHA_tr">
													<th><strong><?php esc_html_e( 'reCAPTCHA Secret key (Private key) :', 'WP2SL' ); ?> </strong></th>
													<td>
														<input type="text" class="oepl_recaptcha_secret_key" value="<?php echo esc_attr( $oepl_recaptcha_secret_key ); ?>" name="oepl_recaptcha_secret_key" id="oepl_recaptcha_secret_key" />
													</td>
												</tr>
												...
												<tr>
													...
													<td>
														<input type="checkbox" name="IPaddrStatus" value="1" class="IPaddrStatus" <?php echo $ip_checked; ?> />
												...
												<tr>
													...
													<td>
														<input type="checkbox" name="EmailNotification" id="EmailNotification" <?php echo $email_checked; ?> />
												...
												<tr class="EmailToTR">
													...
													<td>
														<input type="text" name="EmailReceiver" size="50" id="EmailReceiver" value="<?php echo esc_attr( $email_notification_reveiver ); ?>" />
														<p class="description">
												...
												<tr>
													...
													<td><input type="checkbox" name="OEPL_redirect_user" id="OEPL_redirect_user" <?php echo $redirect_cbx; ?> />
												...
												<tr class="OEPL_redirect_tr">
													...
													<td>
														<input type="text" name="OEPL_redirect_user_to" id="OEPL_redirect_user_to" value="<?php echo $redirect_to; ?>" size="50" />
														<p class="description">
											...
											if ( $_GET['view'] === 'messageSettings' ) {
												...
												<tr>
													...
													<td>
														<textarea class="SuccessMessage" cols="40" rows="2" name="SuccessMessage"><?php echo esc_textarea( $success_msg ); ?></textarea>
												...
												<tr>
													...
													<td>
														<textarea cols="40" rows="2" class="FailureMessage" name="FailureMessage"><?php echo esc_textarea( $failure_msg ); ?></textarea>
												...
												<tr>
													...
													<td>
														<textarea cols="40" rows="2" class="ReqFieldsMessage" name="ReqFieldsMessage"><?php echo esc_textarea( $req_fields_message ); ?></textarea>
												...
												<tr>
													...
													<td>
														<textarea cols="40" rows="2" class="InvalidCaptchaMessage" name="InvalidCaptchaMessage"><?php echo esc_textarea( $invalid_captcha_message ); ?></textarea>
											...
											if ( $_GET['view'] === 'CustomCSS' ) {
												...
												<tr>
													<td class="OEPL_custom_css_td">
														<textarea rows="15" name="OEPL_custom_css" id="OEPL_custom_css"><?php echo esc_textarea( get_option( 'OEPL_Form_Custom_CSS' ) ); ?></textarea>
														...
														<div id="OEPL_form_structure">
															<xmp style="cursor:copy;border: 1px solid #009688;padding: 10px;box-shadow: 0 0 5px #009688 inset !important;">
																<p>
																	<?php esc_html_e( 'Form Message will be displayed here', 'WP2SL' ); ?>
											...
											if ( $_GET['view'] === 'pro' ) {
												...
												?>
												<div class="title">
													<?php esc_html_e( 'WP to CRM Sync PRO', 'WP2SL' ); ?>
												</div>
												<p>
												...
												<hr />
												<p><a class="OEPL-link" href="<?php echo esc_url( 'https://www.youtube.com/watch?feature=player_embedded&v=Ue8XFqC6bnM' ); ?>" target="_blank"><?php esc_html_e( 'Click Here', 'WP2SL' ); ?></a> <?php esc_html_e( 'for detailed video walk through of our', 'WP2SL' ); ?> <strong><?php esc_html_e( "'WP to CRM Sync PRO'.", 'WP2SL' ); ?></strong></p>
